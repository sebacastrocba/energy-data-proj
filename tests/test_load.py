...
class TestLoadToStaging:
    ...
    @patch('fuel_price.load.execute_values')
    @patch('fuel_price.load.get_postgres_connection')
    def test_load_brent_to_staging_without_truncate(self, mock_get_conn, mock_execute_values):
    ...
    @patch('fuel_price.load.execute_values')
    @patch('fuel_price.load.get_postgres_connection')
    def test_load_usd_ars_to_staging_without_brecha(self, mock_get_conn, mock_execute_values):
...
class TestLoadToAnalytics:
    ...
    @patch('fuel_price.load.execute_values')
    @patch('fuel_price.load.get_postgres_connection')
    def test_load_usd_ars_to_analytics_success(self, mock_get_conn, mock_execute_values):
...
class TestLoadAllData:
    ...
    def test_load_all_data_with_analytics(
        self, mock_usd_analytics, mock_fuel_analytics, mock_brent_analytics,
        mock_usd_staging, mock_fuel_staging, mock_brent_staging,
        mock_test_conn
    ):
    ...
    def test_load_all_data_without_analytics(
        self, mock_usd_staging, mock_fuel_staging, mock_brent_staging,
        mock_test_conn
    ):
